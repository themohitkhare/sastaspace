...
import GlobalWarRow from "./global_war_table";
...
const tablesSchema = __schema({
  battle_session: __table({
    name: 'battle_session',
    indexes: [
      { accessor: 'id', name: 'battle_session_id_idx_btree', algorithm: 'btree', columns: [
        'id',
      ] },
      { accessor: 'player_identity', name: 'battle_session_player_identity_idx_btree', algorithm: 'btree', columns: [
        'playerIdentity',
      ] },
    ],
    constraints: [
      { name: 'battle_session_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, BattleSessionRow),
  global_war: __table({
    name: 'global_war',
    indexes: [
      { accessor: 'id', name: 'global_war_id_idx_btree', algorithm: 'btree', columns: [
        'id',
      ] },
    ],
    constraints: [
      { name: 'global_war_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, GlobalWarRow),
  player: __table({
    name: 'player',
  ...
  region: __table({
    name: 'region',
    indexes: [
      { accessor: 'id', name: 'region_id_idx_btree', algorithm: 'btree', columns: [
        'id',
      ] },
    ],
    constraints: [
  ...
  word: __table({
    name: 'word',
    indexes: [
      { accessor: 'id', name: 'word_id_idx_btree', algorithm: 'btree', columns: [
        'id',
      ] },
      { accessor: 'session_id', name: 'word_session_id_idx_btree', algorithm: 'btree', columns: [
        'sessionId',
      ] },
    ],
    constraints: [
