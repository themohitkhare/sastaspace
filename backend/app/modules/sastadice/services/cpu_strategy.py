...
class CpuStrategy:
    ...
    def should_buy_property(
        ...
        """Decide if CPU should buy a property."""
    ...
    def should_bid_in_auction(
        ...
        """Decide if CPU should bid in auction."""
    ...
    def should_upgrade_property(
        ...
        """Decide if CPU should upgrade a property."""
    ...
    def calculate_upgrade_cost(tile: "Tile") -> int:
        """Calculate cost to upgrade a tile."""
    ...
    def should_accept_trade(
        ...
        """Decide if CPU should accept a trade offer."""
    ...
    def should_propose_trade(cpu_player: "Player") -> bool:
        """Decide if CPU should propose a trade."""
        import random
