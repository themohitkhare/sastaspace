...
from app.modules.sastadice.schemas import (
    GameSession, Player, Tile, TileType, ActionType, GameActionRequest
)
...
async def test_upgrade_property_success(game_service):
    ...
    prop1 = Tile(id="t1", name="Red1", type=TileType.PROPERTY, color="RED", price=100, owner_id="p1", upgrade_level=0)
    prop2 = Tile(id="t2", name="Red2", type=TileType.PROPERTY, color="RED", price=100, owner_id="p1", upgrade_level=0)
...
async def test_upgrade_property_level_2(game_service):
    ...
    prop1 = Tile(id="t1", name="Red1", type=TileType.PROPERTY, color="RED", price=100, owner_id="p1", upgrade_level=1)
    prop2 = Tile(id="t2", name="Red2", type=TileType.PROPERTY, color="RED", price=100, owner_id="p1", upgrade_level=0)
...
async def test_upgrade_fail_not_full_set(game_service):
    ...
    prop1 = Tile(id="t1", name="Red1", type=TileType.PROPERTY, color="RED", price=100, owner_id="p1")
    prop2 = Tile(id="t2", name="Red2", type=TileType.PROPERTY, color="RED", price=100, owner_id="p2") # Owned by other
...
async def test_upgrade_fail_insufficient_funds(game_service):
    ...
    prop1 = Tile(id="t1", name="Red1", type=TileType.PROPERTY, color="RED", price=100, owner_id="p1")
    prop2 = Tile(id="t2", name="Red2", type=TileType.PROPERTY, color="RED", price=100, owner_id="p1")
...
async def test_downgrade_property(game_service):
    ...
    prop1 = Tile(id="t1", name="Red1", type=TileType.PROPERTY, color="RED", price=100, owner_id="p1", upgrade_level=2)
    prop2 = Tile(id="t2", name="Red2", type=TileType.PROPERTY, color="RED", price=100, owner_id="p1", upgrade_level=0)
