...
module LandingRails
  class Application < Rails::Application
    ...
    # Path-prefix routing for non-landing apps.
    # Override in each project's config/application.rb:
    #   config.relative_url_root = "/almirah"
    # Landing is at root — no prefix needed.
    # config.relative_url_root = "/<NAME>"
