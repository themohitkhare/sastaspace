...
const TIERS = [
  ...
  },
  {
    ...
    ctaHref: "mailto:hello@sastaspace.com?subject=Studio%20Plan",
    highlighted: true,
    badge: "Most Popular",
    features: [
  ...
  },
  {
    ...
    ctaHref: "mailto:hello@sastaspace.com?subject=Studio%20Pro%20Plan",
    highlighted: false,
    features: [
      { text: "Everything in Studio", included: true },
      { text: "Premium AI redesign", included: true },
      { text: "2 consultation hours", included: true },
      { text: "1 revision round", included: true },
      { text: "Priority support", included: true },
      { text: "Implementation guidance", included: true },
      { text: "Source files delivered", included: true },
    ],
  },
] as const;
...
export default function PricingPage() {
  return (
    <main className="min-h-screen bg-background">
      <div className="w-full max-w-6xl mx-auto px-6 sm:px-8 lg:px-12 py-24">
        <Link
          href="/"
          ...
          {TIERS.map((tier) => (
            <div
              ...
              className={`relative flex flex-col rounded-xl border p-8 ${
                tier.highlighted
                  ? "border-accent ring-2 ring-accent/20 bg-card"
